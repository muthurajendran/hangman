...
--
-- Host: localhost    Database: hangman4
-- ------------------------------------------------------
...
INSERT INTO `auth_user` VALUES (1,'pbkdf2_sha256$12000$i3KwZYgayJ5K$TdbhkYozaRWXnf1Tq9iNiJuNmUxCT72nVHnNLxlDUrU=','2014-01-10 23:51:45',1,'eldho','','','d@d.com',1,1,'2014-01-10 23:51:24'),(2,'!pyOQotStNBTCq0bYMWTIZZQXfNI3hpvIBuytrUA8','2014-01-10 23:52:41',0,'eldhosejohnk','Eldhose','John','dits59@yahoo.com',0,1,'2014-01-10 23:52:41');
...
INSERT INTO `django_admin_log` VALUES (1,'2014-01-10 23:52:49',1,10,'1','Antartica',1,''),(2,'2014-01-10 23:53:11',1,10,'2','India',1,''),(3,'2014-01-10 23:53:23',1,11,'1','Score object',1,''),(4,'2014-01-10 23:53:32',1,11,'2','Score object',1,''),(5,'2014-01-10 23:53:42',1,11,'3','Score object',1,'');
...
INSERT INTO `django_session` VALUES ('1irroe1olrt3whcwcq0adjbeqitafvzu','NWMxNzk1M2Q4OTc4YjE1OGQ2ZWJjYzJjOTIzNjk1ODExYTdlOWRhZjqAAn1xAShVEl9hdXRoX3VzZXJfYmFja2VuZHECVSlkamFuZ28uY29udHJpYi5hdXRoLmJhY2tlbmRzLk1vZGVsQmFja2VuZHEDVQ1fYXV0aF91c2VyX2lkcQSKAQF1Lg==','2014-01-24 23:51:45'),('vda0cwryitoyvk8dnlo4ghcu59d41av6','','2014-03-11 12:45:27');
...
CREATE TABLE `hangmanapp_question` (
  ...
  PRIMARY KEY (`id`),
  KEY `hangmanapp_question_0c98d849` (`created_by_id`),
...
INSERT INTO `hangmanapp_question` VALUES (1,'Antartica','The Ice Continent',2),(2,'India','Democratic Coutry',2);
...
CREATE TABLE `hangmanapp_score` (
  ...
  PRIMARY KEY (`id`),
  KEY `hangmanapp_score_25110688` (`question_id`),
  KEY `hangmanapp_score_6340c63c` (`user_id`),
...
INSERT INTO `hangmanapp_score` VALUES (1,1,2,12),(2,1,1,33),(3,2,2,78);
...
INSERT INTO `social_auth_usersocialauth` VALUES (1,2,'facebook','780901951','{\"access_token\": \"CAAAABOSSmgEBAP6P7VsMyd476Rg1TtTSNBAK5EhT0FXJCa0YPuGKkGesR4W1o0fMnDT3wji4Ku6jkhMHm9irGNwYDZAlsdFZCVZBuaZAW9Gk1O1EsTlkUuceenPbIA7bbvO9EyMbQ0lEZCWdW3wCQkR1MZBtZB81MDns47ZBgCqxskjMSfvtceQREJk5cGc3AZCsZD\", \"expires\": \"5143966\", \"id\": \"780901951\"}');
...
-- Dump completed on 2014-01-11  5:26:18
